import styles from './css/marketingPageClientBlock.module.css';
import { clientBlockData } from '../data/MarketingPageClientBlock';
...
export default function MarketingPageClientBlock() {
