...
function Layout({
  ...
  (0,services/* saveUtmFromParams */.TE)();
...
var external_aos_namespaceObject = require("aos");;
...
const client = new external_react_query_.QueryClient(); //to modify the query cache in react
...
var __webpack_exports__ = __webpack_require__.X(0, [482], function() { return __webpack_exec__(6269); });
