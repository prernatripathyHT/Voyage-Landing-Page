...
const TermsAndConditionsData = {
  ...
  terms: [{
    ...
    id: "5.3",
    title: "Rights You Grant to Us.",
    text: `You hereby grant to Voyage Mobile an irrevocable, perpetual, non-exclusive, transferable, sublicensable, royalty-free, worldwide right and license to use, reproduce, display, perform, distribute, and prepare derivative works of any User Content you post on or send through the Services for any purpose and in all forms and all media, whether now known or that become known in the future, and you waive any and all claims that you may have now or may hereafter have in any jurisdiction to so-called “rental rights,” “moral rights,” and all rights of “droit moral” in that User Content, even if the User Content is altered or changed in a manner not agreeable to you. If you post User Content, you represent and warrant to Voyage Mobile that you own or control all rights in and to such User Content and have the right to grant the rights above to us`
  }, {
    id: "5.4",
    title: "No Responsibility.",
    text: `You agree that you are solely responsible for your User Content, and you acknowledge and agree that Voyage Mobile is not responsible for, and does not endorse, any User Content.`
  }, {
    id: "5.5",
    title: "No Obligation to Prescreen, Monitor or Use.",
    text: `Voyage Mobile does not have, and does not undertake, any obligation to prescreen, monitor, edit, or remove any User Content posted on or through the Services. However, Voyage Mobile retains the right (but not the obligation), in its sole discretion and for any reason, to prescreen, monitor, edit, remove, or move User Content posted on or through the Services. You acknowledge and agree that we are not obligated to post, keep, or use your User Content.`
  }, {
    id: "5.6",
    title: "No Obligation to Prescreen, Monitor or Use.",
    text: `Voyage Mobile does not have, and does not undertake, any obligation to prescreen, monitor, edit, or remove any User Content posted on or through the Services. However, Voyage Mobile retains the right (but not the obligation), in its sole discretion and for any reason, to prescreen, monitor, edit, remove, or move User Content posted on or through the Services. You acknowledge and agree that we are not obligated to post, keep, or use your User Content.`
    ...
    text: `While we appreciate your interest in the Services and our business, Voyage Mobile does not want and cannot accept any ideas or information users consider confidential and/or proprietary. This is to avoid the possibility of future misunderstandings when projects independently developed by or on behalf of Voyage Mobile might seem to others to be similar to users’ own creative ideas, suggestions, and/or materials. Except with respect to your personal information as expressly provided for in our Privacy Policy, all comments, suggestions, ideas, drawings, concepts, or other information or materials disclosed or offered to us by you via the Services or in response to solicitations on the Site shall be deemed to be non- confidential and non-proprietary.`
  }, {
    id: "6",
    title: "Electronic Communications.",
    text: `The communications between you and Voyage Mobile via the Services use electronic means. For contractual purposes, you consent to receive communications from us in electronic form, and you agree that all terms and conditions, agreements, notices, disclosures, and other communications that we provide to you electronically satisfy any legal requirement that such communications be in writing.`
  }, {
    id: "7",
    title: "Other Terms and Conditions.",
    text: `All purchases made through the Services or other transactions for the sale of services formed through the Services are governed by a separate Insertion Order containing any additional terms. Our Insertion Order and any other policies, rules, or guidelines that may be applicable to specific portions or features of the Services are incorporated into these Terms of Use.`
  }, {
    id: "8",
    title: "Privacy Policy.",
    text: `You acknowledge and agree that all information collected by Voyage Mobile is subject to our Privacy Policy. By using the Services, you consent to all actions we take with respect to your information in compliance with our Privacy Policy.`
  }, {
    id: "9",
    title: "Change and Suspension.",
    text: ``
  }, {
    id: "9.1",
    title: "Changes to the Services.",
    text: `Voyage Mobile reserves the right to make changes to, suspend, or discontinue (temporarily or permanently) the Services or any portion thereof (including any Content) at any time. You agree that Voyage Mobile will not be liable to you or to any third party for any such change, suspension, or discontinuance.`
  }, {
    id: "9.2",
    title: "Suspension/Termination of Access.",
    text: `Voyage Mobile has the right to deny access to, and to suspend or terminate your access to, the Services or to any features or portions thereof if you violate these Terms of Use. In the event that we suspend or terminate your access to the Services, you will continue to be bound by the Terms of Use that were in effect as of the date of your suspension or termination.`
  }, {
    id: "10",
    ...
    id: "16.5",
    title: "Filing, Administration and Arbitrator Fees.",
    ...
    id: "16.8",
    title: "Jury trial and class action waiver.",
    text: `If for any reason a claim proceeds in court rather than in arbitration, you and voyage mobile each unconditionally waive any right to a jury trial. This means that any claim would be decided by a judge, not a jury. Further, with respect to any claim that proceeds in a court, you and we agree that each of us may bring claims against the other only on an individual basis and not as a plaintiff or class member in any purported class, or representative or private attorney general action or proceeding.`,
    highlight: "true"
  }, {
    id: "17",
    title: "Miscellaneous.",
    ...
    text: `Any cause of action or claim you may have arising out of or relating to these terms of use or the services (including the content) must be commenced within one (1) year after the cause of action or claim accrues, otherwise, such cause of action or claim is permanently barred.`,
    highlight: "true"
  }, {
    id: "17.4",
    title: "Assignment.",
    ...
    text: `If you are a California resident, in accordance with Cal. Civ. Code §1789.3, you may report complaints to the Complaint Assistance Unit of the Division of Consumer Services of the California Department of Consumer Affairs by contacting them in writing at 1625 North Market Blvd., Suite N 112, Sacramento, CA 95834, or by telephone at <a href="tel:(800) 952-5210">(800) 952-5210</a>.`
  }]
};
// EXTERNAL MODULE: ./components/css/tncPageHeroBanner.module.css
var tncPageHeroBanner_module = __webpack_require__(3172);
var tncPageHeroBanner_module_default = /*#__PURE__*/__webpack_require__.n(tncPageHeroBanner_module);
...
;// CONCATENATED MODULE: ./components/TnCPageHeroBanner.js
...
function TnCPageHeroBanner() {
  ...
  return /*#__PURE__*/jsx_runtime_.jsx("section", {
    className: (tncPageHeroBanner_module_default()).tncPageHeroBanner,
    children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
      className: ` container ${(tncPageHeroBanner_module_default()).heroBanner_innerWrapper}`,
      children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
        className: (tncPageHeroBanner_module_default()).leftBlock,
        children: [/*#__PURE__*/jsx_runtime_.jsx("div", {
          className: (tncPageHeroBanner_module_default()).designElements,
          children: /*#__PURE__*/jsx_runtime_.jsx("img", {
            src: "/images/careers-dots-1.svg",
            alt: "careers-dots-1"
          })
        }), /*#__PURE__*/jsx_runtime_.jsx("h1", {
          className: `title-anim ${(tncPageHeroBanner_module_default()).tncPageTitle}`,
          children: TermsAndConditionsData.titleText
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: `title-anim ${(tncPageHeroBanner_module_default()).lastRevised}`,
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
            children: ["Last Revised: ", TermsAndConditionsData.lastRevised]
          })
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: `${(tncPageHeroBanner_module_default()).termsOfUse}`,
          children: /*#__PURE__*/jsx_runtime_.jsx("p", {
            children: TermsAndConditionsData.termsOfUse
          })
        }), /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
          className: "",
          children: [/*#__PURE__*/jsx_runtime_.jsx("p", {
            className: `${(tncPageHeroBanner_module_default()).tncPageSubText}`,
            children: TermsAndConditionsData.subText_1
          }), /*#__PURE__*/jsx_runtime_.jsx("p", {
            className: `${(tncPageHeroBanner_module_default()).tncPageSubText}`,
            children: TermsAndConditionsData.subText_2
          }), /*#__PURE__*/jsx_runtime_.jsx("p", {
            className: `${(tncPageHeroBanner_module_default()).tncPageSubText}`,
            children: TermsAndConditionsData.subText_3
          })]
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: (tncPageHeroBanner_module_default()).terms,
          children: TermsAndConditionsData.terms.map((term, index) => /*#__PURE__*/jsx_runtime_.jsx("div", {
            className: `${(tncPageHeroBanner_module_default()).termsDetails} ${term.highlight ? (tncPageHeroBanner_module_default()).highlight : null}`,
            children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
              children: [term.id, ". ", term.title, /*#__PURE__*/jsx_runtime_.jsx("span", {
                dangerouslySetInnerHTML: {
                  __html: term.text
                }
              }), term.bullets && /*#__PURE__*/jsx_runtime_.jsx("span", {
                children: /*#__PURE__*/jsx_runtime_.jsx("ul", {
                  children: term.bullets.map((bullet, index) => /*#__PURE__*/jsx_runtime_.jsx("li", {
                    children: bullet
                  }))
                })
              }), term.address && /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
                children: [term.address.subText && /*#__PURE__*/jsx_runtime_.jsx("p", {
                  children: term.address.subText
                }), /*#__PURE__*/jsx_runtime_.jsx("address", {
                  dangerouslySetInnerHTML: {
                    __html: term.address.address
                  }
                }), term.address.note && /*#__PURE__*/(0,jsx_runtime_.jsxs)("p", {
                  children: ["*NOTE: ", /*#__PURE__*/jsx_runtime_.jsx("span", {
                    dangerouslySetInnerHTML: {
                      __html: term.address.note
                    }
                  })]
                })]
              })]
        ...
        className: (tncPageHeroBanner_module_default()).rightBlock,
        children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
          className: (tncPageHeroBanner_module_default()).staticAssets,
          children: [/*#__PURE__*/jsx_runtime_.jsx("svg", {
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M112.024 94.4181L147.724 124V0H0.723633V94.4181H112.024Z",
              fill: "#02D9FC"
            })
          }), /*#__PURE__*/jsx_runtime_.jsx("svg", {
            width: "54",
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("ellipse", {
              rx: "26.8734",
              ry: "26.2762",
              transform: "matrix(-1 0 0 1 27.1266 26.8031)",
              fill: "#5BEBC1"
            })
          }), /*#__PURE__*/jsx_runtime_.jsx("svg", {
            width: "91",
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("path", {
              "fill-rule": "evenodd",
              "clip-rule": "evenodd",
              d: "M67.723 29H91V0H0V29H67.723Z",
              fill: "#405CFB"
            })
          ...
          className: `anim-down ${(tncPageHeroBanner_module_default()).animmateDown}`,
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("svg", {
            ...
            children: [/*#__PURE__*/jsx_runtime_.jsx("path", {
              ...
              d: "M27.562 63.585L0.207644 32.3223L54.9164 32.3223L27.562 63.585Z",
              fill: "#405CFB"
              ...
              rx: "23.1148",
              ry: "22.6012",
              transform: "rotate(-180 27.3623 90.477)",
              fill: "#0E1D37"
            })]
          })
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: `anim-up ${(tncPageHeroBanner_module_default()).animmateUp}`,
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("svg", {
            width: "38",
            height: "90",
            viewBox: "0 0 38 90",
            ...
            xmlns: "http://www.w3.org/2000/svg",
            children: [/*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M38.9584 45L-0.000240248 89.5249L77.917 89.5249L38.9584 45Z",
              fill: "#405CFB"
            }), /*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M38.9584 3.40587e-06L-0.000240248 44.5249L77.917 44.5249L38.9584 3.40587e-06Z",
              fill: "#405CFB"
            })]
          })
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: `anim-left ${(tncPageHeroBanner_module_default()).animateLeft}`,
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("svg", {
            width: "68",
            height: "60",
            viewBox: "0 0 68 60",
            ...
            xmlns: "http://www.w3.org/2000/svg",
            children: [/*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M67.7195 29.5594L34.256 -4.9192e-05L34.256 59.1188L67.7195 29.5594Z",
              fill: "#02D9FC"
            }), /*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M34.2559 29.5594L0.792377 -4.9192e-05L0.792377 59.1188L34.2559 29.5594Z",
              fill: "#02D9FC"
            })]
          })
        }), /*#__PURE__*/jsx_runtime_.jsx("div", {
          className: `anim-right ${(tncPageHeroBanner_module_default()).animateRight}`,
          children: /*#__PURE__*/(0,jsx_runtime_.jsxs)("svg", {
            width: "415",
            height: "89",
            viewBox: "0 0 415 89",
            ...
            children: [/*#__PURE__*/jsx_runtime_.jsx("rect", {
              ...
              "fill-rule": "evenodd",
              "clip-rule": "evenodd",
              d: "M76.6535 67.768L103 89V0H0V67.768H76.6535Z",
              fill: "#5BEBC1"
            })]
          })
        }), /*#__PURE__*/(0,jsx_runtime_.jsxs)("div", {
          className: `anim-stagger ${(tncPageHeroBanner_module_default()).animateStagger}`,
          children: [/*#__PURE__*/jsx_runtime_.jsx("svg", {
            width: "36",
            height: "22",
            viewBox: "0 0 36 22",
            ...
            xmlns: "http://www.w3.org/2000/svg",
            children: /*#__PURE__*/jsx_runtime_.jsx("path", {
              d: "M17.6781 21.0925L5.90062e-05 0.888673L35.3562 0.888676L17.6781 21.0925Z",
              fill: "#405CFB"
            })
          }), /*#__PURE__*/jsx_runtime_.jsx("svg", {
            width: "36",
            ...
            children: /*#__PURE__*/jsx_runtime_.jsx("ellipse", {
              ...
              rx: "14.9382",
              ry: "14.6063",
              transform: "rotate(-180 15.5491 15.4717)",
              fill: "#0E1D37"
            })
          })]
        })]
...
;// CONCATENATED MODULE: ./pages/terms-and-conditions/index.js
  ...
  return /*#__PURE__*/(0,jsx_runtime_.jsxs)(jsx_runtime_.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime_.jsxs)((head_default()), {
      ...
      children: [/*#__PURE__*/jsx_runtime_.jsx(RequestForm/* default */.Z, {
        ...
        setFormState: setFormState
      }), /*#__PURE__*/jsx_runtime_.jsx(TnCPageHeroBanner, {}), /*#__PURE__*/jsx_runtime_.jsx(AboutPageBottomBlock/* default */.Z, {}), /*#__PURE__*/jsx_runtime_.jsx(Footer/* default */.Z, {
        setFormState: setFormState
      })]
    })]
  });
...
// Exports
module.exports = {
	"tncPageHeroBanner": "tncPageHeroBanner_tncPageHeroBanner__1XQn0",
	"heroBanner_innerWrapper": "tncPageHeroBanner_heroBanner_innerWrapper__4AHyg",
	"leftBlock": "tncPageHeroBanner_leftBlock__2Wvs7",
	"designElements": "tncPageHeroBanner_designElements__3o77q",
	"tncPageTitle": "tncPageHeroBanner_tncPageTitle__35Kvi",
	"lastRevised": "tncPageHeroBanner_lastRevised__3rXcn",
	"termsOfUse": "tncPageHeroBanner_termsOfUse__5yFbz",
	"tncPageSubText": "tncPageHeroBanner_tncPageSubText__HbARM",
	"termsDetails": "tncPageHeroBanner_termsDetails__21bLp",
	"highlight": "tncPageHeroBanner_highlight__1GsvZ",
	"staticAssets": "tncPageHeroBanner_staticAssets__2NIi-",
	"animmateDown": "tncPageHeroBanner_animmateDown__3lV7B",
	"animmateUp": "tncPageHeroBanner_animmateUp__21bQn",
	"animateLeft": "tncPageHeroBanner_animateLeft__2y2Bu",
	"animateRight": "tncPageHeroBanner_animateRight__Z7Wux",
	"animateStagger": "tncPageHeroBanner_animateStagger__1efdt",
	"rightBlock": "tncPageHeroBanner_rightBlock__2DhFy"
};
...
var __webpack_exports__ = __webpack_require__.X(0, [664,472,482,81,699], function() { return __webpack_exec__(175); });
