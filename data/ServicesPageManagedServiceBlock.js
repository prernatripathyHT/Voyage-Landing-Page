export const ServicesPageManagedServiceBlockData = {
    mainBlockTitle: "Managed Service: Charter Your Voyage",
    mainBlockData: 
    `<p>If all of the above sounds like smooth sailing, but you want more guidance on your SMS journey, Voyage Compass can also be utilized as a managed service.</p>
